	...
	return (
		<S.LogoContainer
			className={`
				...
				${size === 'normal' ? 'w-[11rem] h-[3.3rem]' : 'w-[20rem] h-[5.2rem]'} 
				${
					hideOnMobile && width < 768
						? 'w-[5.8rem] h-[4.5rem] overflow-hidden'
						: 'showOnMobile'
				}
			`}
		>
			...
			>
				...
				<path
					className={`${
						hideOnMobile && width < 768 ? 'hidden' : 'showOnMobile'
					}`}
					fill="currentColor"
